...
export default function TaskQueuePage() {
  ...
  useEffect(() => {
    try {
      ...
      if (raw) setTasks((JSON.parse(raw) as Task[]).map(t => ({ ...t, timerRunning: false })))
    } catch { /* ignore */ }
  }, [])
  ...
  }, [selectedId, tasks, queue, startEdit, setTaskState, toggleTimer, removeTask, moveTask])
